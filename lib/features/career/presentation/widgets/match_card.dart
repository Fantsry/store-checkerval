...
class _MatchCardState extends State<MatchCard> {
  ...
  Widget _buildRoundKillsView(MatchSummary match) {
    ...
    return Column(
      ...
      children: match.rounds.map((round) {
              ...
              if (round.kills.isEmpty)
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, idx) {
                    ...
                    return _RoundKillFeedTile(kill: kill);
                  },
                ),
            ],
          ),
...
class _RoundKillFeedTile extends StatelessWidget {
  final MatchRoundKill kill;

  const _RoundKillFeedTile({required this.kill});
